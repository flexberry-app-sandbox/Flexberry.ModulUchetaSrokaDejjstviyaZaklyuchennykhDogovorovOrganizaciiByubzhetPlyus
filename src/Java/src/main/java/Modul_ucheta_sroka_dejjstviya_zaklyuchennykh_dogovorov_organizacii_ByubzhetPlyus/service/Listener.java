package Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov_organizacii_ByubzhetPlyus.service;
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            final JPAODataCRUDContextAccess serviceContext = JPAODataServiceContext.with()
                    ...
                    .setDataSource(ds)
                    .setTypePackage("Modul_ucheta_sroka_dejjstviya_zaklyuchennykh_dogovorov_organizacii_ByubzhetPlyus.model")
                    .build();
